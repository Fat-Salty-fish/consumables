...
import com.sinoyd.artifact.criteria.AddingRecordViewCriteria;
...
public class ConsumableDetailController extends BaseController {
    ...
    public Object findAddingRecord(AddingRecordViewCriteria criteria) {
        PageBean pageBean = super.getPageBean();
        consumableDetailService.findAddingRecord(pageBean, criteria);
        return super.setJsonPaginationMap(pageBean);
    }
}
